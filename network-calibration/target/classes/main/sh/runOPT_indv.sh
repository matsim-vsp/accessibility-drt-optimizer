...
#SBATCH --job-name=network-opt-indv         # name of your run, will be displayed in the joblist
...
input="input/*"
model="org.matsim.application.prepare.network.params.ref.IndividualParams"
